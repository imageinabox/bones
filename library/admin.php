...
function bones_rss_dashboard_widget() {
	if(function_exists('fetch_feed')) {
		...
		$feed = fetch_feed('http://www.imageinabox.com/rss/');        // specify the source feed
...
function bones_custom_dashboard_widgets() {
	wp_add_dashboard_widget('bones_rss_dashboard_widget', __('Recently on Image In A Box', 'bonestheme'), 'bones_rss_dashboard_widget');
	/*
